...
TEST( TREE_WALKING_INTERPRETER_IF_STATMENT, VARIBLE_LESS_INT )
{
   // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_IF_STATMENT, INT_LESS_INT )
{
   // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_IF_STATMENT, BIN_EXPR_LESS_BIN_EXPR )
{
   // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_IF_STATMENT, IF_ELSE_TRUE_BRANCH )
{
   // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_IF_STATMENT, IF_ELSE_FALSE_BRANCH )
{
   // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_IF_STATMENT, NESTED_IF_ELSE )
{
   // ARRANGE
   const auto& input = R"""({
      var a = 5;
...
TEST( TREE_WALKING_INTERPRETER_IF_STATMENT, IF_ELSE_WITH_VARIABLES )
{
   // ARRANGE
   const auto& input = R"""({
      var result = 0;
...
TEST( TREE_WALKING_INTERPRETER_IF_STATMENT, IF_ELSE_CHAIN )
{
   // ARRANGE
   const auto& input = R"""({
      var score = 85;
...
TEST( TREE_WALKING_INTERPRETER_IF_STATMENT, IF_WITH_ARRAY_CONDITION )
{
   // ARRANGE
   const auto& input = R"""({
      var arr = [1, 2, 3];
