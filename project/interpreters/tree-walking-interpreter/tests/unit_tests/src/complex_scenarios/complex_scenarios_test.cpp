...
TEST( TREE_WALKING_INTERPRETER_COMPLEX_SCENARIOS, WHILE_WITH_IF_AND_FUNCTIONS )
{
    // ARRANGE
    const auto& input = R"""({
        function isEven(n) {
...
TEST( TREE_WALKING_INTERPRETER_COMPLEX_SCENARIOS, ARRAY_PROCESSING_WITH_FUNCTIONS )
{
    // ARRANGE
    const auto& input = R"""({
...
TEST( TREE_WALKING_INTERPRETER_COMPLEX_SCENARIOS, OBJECT_MANIPULATION_WITH_LOOPS )
{
    // ARRANGE
    const auto& input = R"""({
...
TEST( TREE_WALKING_INTERPRETER_COMPLEX_SCENARIOS, NESTED_FUNCTION_WITH_CLOSURE )
{
    // ARRANGE
    const auto& input = R"""({
...
TEST( TREE_WALKING_INTERPRETER_COMPLEX_SCENARIOS, RECURSIVE_TREE_TRAVERSAL )
{
    // ARRANGE
    const auto& input = R"""({
...
TEST( TREE_WALKING_INTERPRETER_COMPLEX_SCENARIOS, MATRIX_OPERATIONS )
{
    // ARRANGE
    const auto& input = R"""({
...
TEST( TREE_WALKING_INTERPRETER_COMPLEX_SCENARIOS, SCOPE_AND_VARIABLE_SHADOWING )
{
    // ARRANGE
    const auto& input = R"""({
        var global_x = 100;
...
TEST( TREE_WALKING_INTERPRETER_COMPLEX_SCENARIOS, CALCULATOR_WITH_OPERATIONS )
{
    // ARRANGE
    const auto& input = R"""({
