...
TEST( TREE_WALKING_INTERPRETER_MEMBER_EXPRESSION, ARRAY_READ_INDEX )
{
    // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_MEMBER_EXPRESSION, EMPTY_ARRAY_READ_INDEX )
{
    // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_MEMBER_EXPRESSION, ARRAY_WRITE_INDEX )
{
    // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_MEMBER_EXPRESSION, EMPTY_ARRAY_WRITE_INDEX )
{
    // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_MEMBER_EXPRESSION, ARRAY_MODIFY_AND_RETURN_ARRAY )
{
    // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_MEMBER_EXPRESSION, OBJECT_READ_PROPERTY )
{
    // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_MEMBER_EXPRESSION, OBJECT_WRITE_PROPERTY )
{
    // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_MEMBER_EXPRESSION, OBJECT_ADD_NEW_PROPERTY )
{
    // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_MEMBER_EXPRESSION, OBJECT_MODIFY_AND_RETURN_OBJECT )
{
    // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_MEMBER_EXPRESSION, NESTED_ARRAY_ACCESS )
{
    // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_MEMBER_EXPRESSION, NESTED_OBJECT_ACCESS )
{
    // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_MEMBER_EXPRESSION, VARIABLE_INDEX_ACCESS )
{
    // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_MEMBER_EXPRESSION, EXPRESSION_INDEX_ACCESS )
{
    // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_MEMBER_EXPRESSION, DOT_OBJECT_READ_PROPERTY )
{
    // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_MEMBER_EXPRESSION, DOT_OBJECT_WRITE_PROPERTY )
{
    // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_MEMBER_EXPRESSION, DOT_OBJECT_ADD_PROPERTY )
{
    // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_MEMBER_EXPRESSION, DOT_CHAINED_ACCESS )
{
    // ARRANGE
