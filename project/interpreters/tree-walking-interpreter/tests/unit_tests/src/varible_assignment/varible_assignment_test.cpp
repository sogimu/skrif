...
TEST( TREE_WALKING_INTERPRETER_VARIBLE_ASSIGNMENT, LOCAL_READ_WRITE_INT )
{
   // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_VARIBLE_ASSIGNMENT, LOCAL_READ_WRITE_DOUBLE )
{
   // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_VARIBLE_ASSIGNMENT, LOCAL_READ_WRITE_STRING )
{
   // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_VARIBLE_ASSIGNMENT, LOCAL_READ_WRITE_ARRAY )
{
   // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_VARIBLE_ASSIGNMENT, LOCAL_READ_WRITE_OBJECT )
{
   // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_VARIBLE_ASSIGNMENT, GLOBAL_READ_WRITE_INT )
{
   // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_VARIBLE_ASSIGNMENT, GLOBAL_READ_WRITE_DOUBLE )
{
   // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_VARIBLE_ASSIGNMENT, GLOBAL_READ_WRITE_STRING )
{
   // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_VARIBLE_ASSIGNMENT, GLOBAL_READ_WRITE_ARRAY )
{
   // ARRANGE
...
TEST( TREE_WALKING_INTERPRETER_VARIBLE_ASSIGNMENT, GLOBAL_READ_WRITE_OBJECT )
{
   // ARRANGE
